...
int main(int argc, char * argv[]) 
{
    ...
    int ch;
    //_andy_   char* theConfigFilePath = "c:\\Program Files\\Darwin Streaming Server\\streamingserver.cfg";
    //_andy_   char* theXMLFilePath = "c:\\Program Files\\Darwin Streaming Server\\streamingserver.xml";
    char* theConfigFilePath = "c:\\Darwin Streaming Server\\streamingserver.cfg";
    char* theXMLFilePath = "c:\\Darwin Streaming Server\\streamingserver.xml";
