...
Bool16 QTFile::GenerateAtomTOC(void)
{
    ...
    while( Read(CurPos, (char *)&atomLength, 4) ) {
        ...
        if (0 == BigAtomLength)
        {
            DEEP_DEBUG_PRINT(("QTFile::GenerateAtomTOC - Bail atom is bad. type= '%c%c%c%c'; pos=%I64u; length=%I64u; header=%lu.\n",
        ...
        if (hasBigAtom)
        {    DEEP_DEBUG_PRINT(("QTFile::GenerateAtomTOC - Found 64 bit atom '%c%c%c%c'; pos=%I64u; length=%I64u; header=%lu.\n",
            (char)((AtomType & 0xff000000) >> 24),
            (char)((AtomType & 0x00ff0000) >> 16),
            (char)((AtomType & 0x0000ff00) >> 8),
            (char)((AtomType & 0x000000ff)),
        ...
        {    DEEP_DEBUG_PRINT(("QTFile::GenerateAtomTOC - Found 32 bit atom '%c%c%c%c'; pos=%I64u; length=%I64u; header=%lu.\n",
            (char)((AtomType & 0xff000000) >> 24),
            (char)((AtomType & 0x00ff0000) >> 16),
            (char)((AtomType & 0x0000ff00) >> 8),
            (char)((AtomType & 0x000000ff)),
...
void QTFile::DumpAtomTOC(void)
{
    ...
    for( Atom = fTOC; Atom != NULL; ) 
    {
        ...
        // Print out this atom.     
        DEBUG_PRINT(("%s[%03lu] AtomType=%c%c%c%c; AtomDataPos=%I64u; AtomDataLength=%I64u\n",
        Indent,
        Atom->TOCID,
        (char)((Atom->AtomType & 0xff000000) >> 24),
        (char)((Atom->AtomType & 0x00ff0000) >> 16),
