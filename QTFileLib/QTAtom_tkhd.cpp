 ...
 *
 */
// $Id: QTAtom_tkhd.cpp,v 1.10 2003/08/15 23:53:14 sbasu Exp $
//
// QTAtom_tkhd:
...
Bool16 QTAtom_tkhd::Initialize(void)
{
    ...
    if (0 == fVersion)
    {
       // Verify that this atom is the correct length.
        ...
        {
            DEEP_DEBUG_PRINT(("QTAtom_tkhd::Initialize failed. Expected AtomDataLength == 84 version: %d AtomDataLength: %I64u\n",fVersion, fTOCEntry.AtomDataLength));
            return false;
        }
    ...
    {   
       // Verify that this atom is the correct length.
        ...
        {
            DEEP_DEBUG_PRINT(("QTAtom_tkhd::Initialize failed. Expected AtomDataLength == 96 version: %d AtomDataLength: %I64u\n",fVersion, fTOCEntry.AtomDataLength));
            return false;
        }
