...
Bool16 QTAtom_mdhd::Initialize(void)
{
    ...
    if (0 == fVersion)
    {
        ...
        {
            DEEP_DEBUG_PRINT(("QTAtom_mdhd::Initialize failed. Expected AtomDataLength == 24 version: %d AtomDataLength: %I64u\n",fVersion, fTOCEntry.AtomDataLength));
            return false;
        }
    ...
    else if (1 == fVersion)
    {
        ...
        {
            DEEP_DEBUG_PRINT(("QTAtom_mdhd::Initialize failed. Expected AtomDataLength == 36 version: %d AtomDataLength: %I64u\n",fVersion, fTOCEntry.AtomDataLength));
            return false;
        }
