...
Bool16 QTAtom_mvhd::Initialize(void)
{
    ...
    if (0 == fVersion)
    {
        ...
        {
            DEEP_DEBUG_PRINT(("QTAtom_mvhd::Initialize failed. Expected AtomDataLength == 100 version: %d AtomDataLength: %I64u\n",fVersion, fTOCEntry.AtomDataLength));
            return false;
        }
    ...
    else if (1 == fVersion)
    {
        ...
        {
            DEEP_DEBUG_PRINT(("QTAtom_mvhd::Initialize failed. Expected AtomDataLength = 112 version: %d AtomDataLength: %I64u\n",fVersion, fTOCEntry.AtomDataLength));
            return false;
        }
